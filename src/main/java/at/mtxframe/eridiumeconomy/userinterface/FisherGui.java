...
public class FisherGui implements CommandExecutor {
    private final EridiumEconomy plugin;
    DatabaseJobs jobsDatabase = new DatabaseJobs();

    public FisherGui(EridiumEconomy plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand (CommandSender sender, Command command, String s, String[]args) {
        if (sender instanceof Player) {
            ...
            Inventory minerInventory = Bukkit.createInventory(player, 36, ChatColor.AQUA + "" + ChatColor.BOLD + "Fischer");
            //Info-Buch
            ...
            infoLore.add(ChatColor.GREEN + "Aktuelle Chance: " + ChatColor.LIGHT_PURPLE + dropChances.get(jobStats.getFisherLevel()));
            ...
            m2Lore.add(ChatColor.GRAY + "Fisher ist Work In Progress.");
            ...
            m3Lore.add(ChatColor.GRAY + "Fisher ist Work In Progress.");
            ...
            m4Lore.add(ChatColor.GRAY + "Fisher ist Work In Progress.");
            m4Lore.add(ChatColor.GRAY + "Fisher ist Work In Progress.");
            ...
            m5Lore.add(ChatColor.GRAY + "Fisher ist Work In Progress.");
            m5Lore.add(ChatColor.GRAY + "Fisher ist Work In Progress.");
            ...
            m6Lore.add(ChatColor.GRAY + "Fisher ist Work In Progress.");
            m6Lore.add(ChatColor.GRAY + "Fisher ist Work In Progress.");
            ...
            m7Lore.add(ChatColor.GRAY + "Fisher ist Work In Progress.");
            m7Lore.add(ChatColor.GRAY + "Fisher ist Work In Progress.");
            ...
            m9Lore.add(ChatColor.GRAY + "Fisher ist Work In Progress.");
            m9Lore.add(ChatColor.GRAY + "Fisher ist Work In Progress.");
            ...
            m10Lore.add(ChatColor.GRAY + "Fisher ist Work In Progress.");
            m10Lore.add(ChatColor.GRAY + "Fisher ist Work In Progress.");
