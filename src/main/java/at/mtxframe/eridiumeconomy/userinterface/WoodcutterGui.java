...
public class WoodcutterGui implements CommandExecutor {
    ...
    public WoodcutterGui(EridiumEconomy plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand (CommandSender sender, Command command, String s, String[]args) {
        if (sender instanceof Player) {
            ...
            Inventory minerInventory = Bukkit.createInventory(player, 36, ChatColor.DARK_GREEN + "" + ChatColor.BOLD + "Holzfäller");
            //Info-Buch
            ...
            infoLore.add(ChatColor.GREEN + "Aktuelle Chance: " + ChatColor.LIGHT_PURPLE + dropChances.get(jobStats.getWoodcutterLevel()));
            ...
            if (jobStats.getWoodcutterLevel() < 5) {
                m1M.setDisplayName(ChatColor.RED + "Level 5");
            } else {
                m1M.setDisplayName(ChatColor.GREEN + "Level 5");
            }
            m1Lore.add(ChatColor.GREEN + "SPEZIAL");
            m1Lore.add(ChatColor.GRAY + "Auf diesem Level schaltest die Kettensäge frei, damit fällst du einen ganzen Baum!");
            m1Lore.add(ChatColor.BLUE + "Kettensäge" + ChatColor.GRAY + " Abklingzeit: " + ChatColor.GREEN + "1 Minute");
            m1M.setLore(m1Lore);
            m1.setItemMeta(m1M);
            ...
            if (jobStats.getWoodcutterLevel() < 10) {
            ...
            m2Lore.add(ChatColor.GRAY + "Kettensäge" + ChatColor.GRAY + " Abklingzeit: " + ChatColor.GREEN + " 50 Sekunden");
            ...
            if (jobStats.getWoodcutterLevel() < 15) {
            ...
            m3Lore.add("Kettensäge" + ChatColor.GRAY + " Abklingzeit: " + ChatColor.GREEN + " 40 Sekunden");
            m3Lore.add("Chance auf doppelte Drops: " + ChatColor.GREEN + "+" + ChatColor.DARK_PURPLE + "1.50%");
            m3M.setLore(m3Lore);
            m3.setItemMeta(m3M);
            ...
            if (jobStats.getWoodcutterLevel() < 20) {
            ...
            m4Lore.add("Kettensäge" + ChatColor.GRAY + " Abklingzeit: " + ChatColor.GREEN + " 35 Sekunden");
            m4Lore.add("Chance auf doppelte Drops: " + ChatColor.GREEN + "+" + ChatColor.DARK_PURPLE + "1.50%");
            m4M.setLore(m4Lore);
            ...
            if (jobStats.getWoodcutterLevel() < 25) {
            ...
            m5Lore.add("Kettensäge" + ChatColor.GRAY + " Abklingzeit: " + ChatColor.GREEN + " 25 Sekunden");
            m5Lore.add("Chance auf doppelte Drops: " + ChatColor.GREEN + "+" + ChatColor.DARK_PURPLE + "1.50%");
            m5M.setLore(m5Lore);
            m5.setItemMeta(m5M);
            ...
            if (jobStats.getWoodcutterLevel() < 30) {
            ...
            m6Lore.add("Kettensäge" + ChatColor.GRAY + " Abklingzeit: " + ChatColor.GREEN + " 20 Sekunden");
            m6Lore.add("Chance auf doppelte Drops: " + ChatColor.GREEN + "+" + ChatColor.DARK_PURPLE + "1.50%");
            m6M.setLore(m6Lore);
            m6.setItemMeta(m6M);
            ...
            if (jobStats.getWoodcutterLevel() < 35) {
            ...
            m7Lore.add(ChatColor.GRAY + "Deine" + ChatColor.DARK_GREEN + " Kettensäge"  + ChatColor.GRAY + " fällt jetzt auch Jungelbäume ab.");
            m7Lore.add("Chance auf doppelte Drops: " + ChatColor.GREEN + "+" + ChatColor.DARK_PURPLE + "1.50%");
            m7M.setLore(m7Lore);
            m7.setItemMeta(m7M);
            ...
            if (jobStats.getWoodcutterLevel() < 40) {
            ...
            m8Lore.add(ChatColor.GRAY + "Auf diesem Level schaltest du einen Helfer frei der");
            m8Lore.add(ChatColor.GRAY + "Bäume für dich pflanzen kann.");
            m8Lore.add("Kettensäge" + ChatColor.GRAY + " Abklingzeit: " + ChatColor.GREEN + " 15 Sekunden");
            m8M.setLore(m8Lore);
            m8.setItemMeta(m8M);
            ...
            if (jobStats.getWoodcutterLevel() < 45) {
            ...
            m9Lore.add(ChatColor.GRAY + "Du kannst deine gehaltene" + ChatColor.BLUE + " Axt " + ChatColor.GRAY + "alle " + ChatColor.GREEN);
            m9Lore.add("Chance auf doppelte Drops: " + ChatColor.GREEN + "+" + ChatColor.DARK_PURPLE + "1.50%");
            m9M.setLore(m9Lore);
            m9.setItemMeta(m9M);
            ...
            if (jobStats.getWoodcutterLevel() < 50) {
