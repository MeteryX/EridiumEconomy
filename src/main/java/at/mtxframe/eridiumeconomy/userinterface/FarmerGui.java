...
public class FarmerGui implements CommandExecutor {
    private  final EridiumEconomy plugin;
    DatabaseJobs jobsDatabase = new DatabaseJobs();

    public  FarmerGui(EridiumEconomy plugin){
        this.plugin = plugin;
    }
    ...
    public boolean onCommand (CommandSender sender, Command command, String s, String[]args) {
        if (sender instanceof Player) {
            ...
            Inventory minerInventory = Bukkit.createInventory(player, 36,ChatColor.GREEN + "" + ChatColor.BOLD + "Farmer");
            //Info-Buch
            ...
            infoLore.add(ChatColor.GREEN + "Aktuelle Chance: " + ChatColor.LIGHT_PURPLE + dropChances.get(jobStats.getFarmerLevel()));
            ...
            m2Lore.add(ChatColor.GRAY + "Farmer ist Work In Progress");
            ...
            m3Lore.add(ChatColor.GRAY + "Farmer ist Work In Progress");
            m3Lore.add(ChatColor.GRAY + "Die Fähigkeit wird später verschiedene Abklingzeiten je nach Level haben.");
            m3M.setLore(m3Lore);
            m3.setItemMeta(m3M);
            ...
            m4Lore.add(ChatColor.GRAY + "Farmer ist Work In Progress");
            m4Lore.add(ChatColor.GRAY + "Farmer ist Work In Progress");
            m4M.setLore(m4Lore);
            ...
            m5Lore.add(ChatColor.GRAY + "Farmer ist Work In Progress");
            m5Lore.add(ChatColor.GRAY + "Farmer ist Work In Progress");
            m5M.setLore(m5Lore);
            m5.setItemMeta(m5M);
            ...
            m6Lore.add(ChatColor.GRAY + "Farmer ist Work In Progress");
            m6Lore.add(ChatColor.GRAY + "Farmer ist Work In Progress");
            m6M.setLore(m6Lore);
            m6.setItemMeta(m6M);
            ...
            m7Lore.add(ChatColor.GRAY + "Farmer ist Work In Progress");
            m7Lore.add(ChatColor.GRAY + "Farmer ist Work In Progress");
            m7M.setLore(m7Lore);
            m7.setItemMeta(m7M);
            ...
            m8Lore.add(ChatColor.GRAY + "Auf diesem Level schaltest du einen Begleiter frei der");
            ...
            m9Lore.add(ChatColor.GRAY + "Farmer ist Work In Progress");
            m9Lore.add(ChatColor.GRAY + "Farmer ist Work In Progress");
            m9M.setLore(m9Lore);
            m9.setItemMeta(m9M);
            ...
            m10Lore.add(ChatColor.GRAY + "Farmer ist Work In Progress");
            m10Lore.add(ChatColor.GRAY + "Farmer ist Work In Progress");
